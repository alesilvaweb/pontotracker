...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIMESHEETAUDIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TIMESHEETAUDIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TIMESHEETAUDIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TIMESHEETAUDIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TIMESHEETAUDIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TIMESHEETAUDIT actions', async () => {
      const arg = 42666;
