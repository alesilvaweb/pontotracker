...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIMEENTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TIMEENTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TIMEENTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TIMEENTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TIMEENTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TIMEENTRY actions', async () => {
      const arg = 42666;
