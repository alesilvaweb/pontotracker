...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPREFERENCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERPREFERENCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERPREFERENCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERPREFERENCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERPREFERENCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERPREFERENCE actions', async () => {
      const arg = 42666;
