...
export const getEntities = createAsyncThunk(
  'userPreference/fetch_entity_list',
...
export const partialUpdateEntity = createAsyncThunk(
  'userPreference/partial_update_entity',
  async (entity: IUserPreference, thunkAPI) => {
