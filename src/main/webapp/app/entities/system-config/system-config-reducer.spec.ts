...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEMCONFIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYSTEMCONFIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SYSTEMCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SYSTEMCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEMCONFIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYSTEMCONFIG actions', async () => {
      const arg = 42666;
