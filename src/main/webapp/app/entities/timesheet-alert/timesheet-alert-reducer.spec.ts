...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIMESHEETALERT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TIMESHEETALERT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TIMESHEETALERT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TIMESHEETALERT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TIMESHEETALERT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TIMESHEETALERT actions', async () => {
      const arg = 42666;
