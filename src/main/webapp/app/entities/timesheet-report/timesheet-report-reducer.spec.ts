...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIMESHEETREPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TIMESHEETREPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TIMESHEETREPORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TIMESHEETREPORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TIMESHEETREPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TIMESHEETREPORT actions', async () => {
      const arg = 42666;
